...
As a result, Spaun is able to match
experimental data across the spectrum
of neuroscientific data,
from the single cell level
to the behavioral level,
despite experimental data
being a very small part of the model description.
Similarly, while this is made possible
by a theoretical framework,
the NEF enables Spaun to employ
many different algorithms with spiking neurons,
rather than defining a single algorithm
that is replicated many times.
